        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-6 h-6 bg-gradient-to-r from-orange-500 via-pink-500 to-violet-500 rounded"></div>
              <span className="text-lg font-bold text-gray-800">Dev Stack</span>
            </div>
